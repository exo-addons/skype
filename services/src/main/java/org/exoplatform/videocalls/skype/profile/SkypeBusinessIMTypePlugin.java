 ...
 */
public class SkypeBusinessIMTypePlugin extends BaseComponentPlugin implements IMTypePlugin {

  /**
   * The Class SfBIMType.
   */
  class SfBIMType implements IMType {
    ...
    @Override
    public String getId() {
      return SkypeBusinessProvider.SFB_TYPE;
    }
  ...
  /**
   * Instantiates a new Skype for Business IM type plugin.
   */
  public SkypeBusinessIMTypePlugin() {
    //
  }
