 ...
 */
package org.exoplatform.webconferencing.skype.profile.webui;
...
/**
 * Skype for Business IM control renderer for user profile form.
 * 
 ...
 */
public class SkypeBusinessIMRenderer extends UIIMControlRenderer {

  /**
   * Instantiates a new skype business IM renderer.
   *
   * @param imtype the imtype
   */
  SkypeBusinessIMRenderer(IMType imtype) {
    super(imtype);
  }
  ...
  public void render(String imValue, WebuiRequestContext context) throws IOException, Exception {
    ...
    context.getJavascriptManager().require("SHARED/webConferencing_mssfb", "mssfbProvider");
    //.addScripts("if (mssfbProvider) { mssfbProvider.initUser(); }");
    // TODO user profile validation here?
  }
